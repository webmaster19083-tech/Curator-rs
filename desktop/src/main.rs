...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            // hidden/tray-only desktop process remains reachable through the
            // loopback browser fallback and explicitly bound Tailscale
            // addresses without a second server.
            handle
