...
=======
        ...
        "auto" => " AND m.human_rating IS NULL AND (m.auto_rating>0 OR m.action_rating>0)",
        "needs_review" => " AND m.human_rating IS NULL AND (m.manual_review_required=1 OR m.auto_rating>0 OR m.action_rating>0)",
